...
//          document.getElementById(fNamenew+"zip").value = items[2];
    ...
    function getCom() {
      var orderId = '<%=orderId%>';
      var url = "<%=rootUpdate%>order.edit.com.sec.d.jsp/?orderId=" + orderId +  "&comType=greeting";
...
<body>
        ...
        <form action="<%=rootUpdate%>order.edit.sec.d.jsp/" method="POST">
          <div class="form-group">
            ...
            <select class="form-control" id="status" name="status">
              ...
              %>
              <option value="<%= sstatus %>" <%= sstatus.equals(currentStatus) ? "selected" : "" %>><%= (new Translate()).translate(sstatus, usernameOBJ.getLanguage())%></option>
              <%
                }
              %>
            </select>
