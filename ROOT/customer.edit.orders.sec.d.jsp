...
<body>
        ...
        %>
        <a href="<%=rootUpdate%>customer.edit.sec.d.jsp/?customerId=<%= entity.getId() %>" ><%= entity.getFirstName() %>, <%= entity.getLastName() %></a><br>
        <%= entity.getEmail() %><BR>
        <%= entity.getPhone() %><BR>
        <HR>
        <a href="<%=rootUpdate%>order.edit.customers.sec.d.jsp/?action=add&customerId=<%= entity.getId() %>" >Add Order</a>
        <HR>
                    <%
